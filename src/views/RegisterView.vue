	...
	<main class="mainWrapper px-3 sm:px-5">
		...
		>
			...
			<form @submit.prevent="register">
				...
				<p class="mb-5">
					<label class="text-sm text-gray-700 block mb-1 font-medium">メールアドレス</label
					><input
						v-model="email"
						type="email"
						class="text-base bg-gray-100 border border-gray-200 rounded py-1 px-3 inline-block text-gray-700 placeholder:text-neutral-500 placeholder:text-xs w-full"
				...
				<p class="mb-5">
					<label class="text-sm text-gray-700 block mb-1 font-medium">パスワード</label
					><input
						v-model="password"
						type="password"
						class="text-base bg-gray-100 border border-gray-200 rounded py-1 px-3 inline-block text-gray-700 placeholder:text-neutral-500 placeholder:text-xs w-full"
				...
				<p class="mb-5">
					<label class="text-sm text-gray-700 block mb-1 font-medium">パスワード確認</label
					><input
